...
STAGE_DATA stage05_setData[] = {
	...
	STAGE_DATA(e_startPagination[5], 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(470,220,1),		true, v3(150,11,0), 2, recoveryControl),
	...
	STAGE_DATA(e_startPagination[5], 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(155,680,1),		true, v3(155,11,0), 2, recoveryControl),
	STAGE_DATA(e_startPagination[5], 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,	v3(465,680-8,1),		true, v3(155,11,0), 2, recoveryControl),
	...
	STAGE_DATA(e_startPagination[5] + 1, 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,	v3(PW / 2,220-8,1),		true, v3(160,11,0), 2, recoveryControl),
	STAGE_DATA(e_startPagination[5] + 1, 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(500,540,1),		true, v3(120,11,0), 2, recoveryControl),
