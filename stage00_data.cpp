...
STAGE_DATA stage00_setData[] = {
	...
	STAGE_DATA(0, MAPOBJ_HIGH_CONCENTRATION, DRAW_UP, true, v3(0,350,0),true, v3(PW,230,0), 5),

	STAGE_DATA(0, MAPOBJ_DOOR, DRAW_UP, true, v3(10,1676,0),true, v3(51,76,0), 10),
	STAGE_DATA(0, MAPOBJ_KEY, DRAW_UP, true, v3(10,930-50,0),true, v3(50,50,0), 10),
