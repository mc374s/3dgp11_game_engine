...
STAGE_DATA stage00_setData[] = {
	...
	STAGE_DATA(e_startPagination[0], 0, M_TYPE::RECOVERY_UP,				M_DRAW::UP,		v3(470,220,1),		true, v3(150,22,0), 3, recoveryControl),
	...
	STAGE_DATA(e_startPagination[0], 0, M_TYPE::IVY_THICK,				M_DRAW::UP,		v3(PW / 2,680,1),		true, v3(155,17,0), 10),
	STAGE_DATA(e_startPagination[0], 0, M_TYPE::RECOVERY_UP,				M_DRAW::UP,		v3(155,680,1),		true, v3(155,22,0), 3, recoveryControl),
	STAGE_DATA(e_startPagination[0], 0, M_TYPE::RECOVERY_DOWN,			M_DRAW::DOWN,	v3(465,680,1),		true, v3(155,22,0), 3, recoveryControl),



	STAGE_DATA(e_startPagination[0], 0, M_TYPE::IVY_THICK,				M_DRAW::UP,		v3(0,900,1),		true, v3(PW,17,0), 10),
	...
	STAGE_DATA(e_startPagination[0] + 1, 0, M_TYPE::IVY_THICK,				M_DRAW::UP,		v3(0,540,1),		true, v3(500,17,0), 10),
	STAGE_DATA(e_startPagination[0] + 1, 0, M_TYPE::IVY_THICK,				M_DRAW::UP,		v3(0,900,1),		true, v3(PW,17,0), 10),

	STAGE_DATA(e_startPagination[0] + 1, 0, M_TYPE::RECOVERY_DOWN,			M_DRAW::DOWN,	v3(PW / 2,215,1),		true, v3(160,22,0), 3, recoveryControl),
