...
STAGE_DATA stage00_setData[] = {
	...
	STAGE_DATA(61, 0, M_TYPE::RECOVERY_UP,				M_DRAW::UP,		v3(470,220,1),		true, v3(150,22,0), 2, recoveryControl),
	...
	STAGE_DATA(61, 0, M_TYPE::HIGH_CONCENTRATION,		M_DRAW::UP,		v3(0,420,0),		true, v3(PW / 2,260,0), 3),

	STAGE_DATA(61, 0, M_TYPE::IVY_THICK,				M_DRAW::UP,		v3(0,680,1),		true, v3(155,17,0), 10),
	STAGE_DATA(61, 0, M_TYPE::IVY_THICK,				M_DRAW::UP,		v3(PW / 2,680,1),		true, v3(310,17,0), 10),
	STAGE_DATA(61, 0, M_TYPE::RECOVERY_UP,				M_DRAW::UP,		v3(155,680,1),		true, v3(155,22,0), 2, recoveryControl),
	...
	STAGE_DATA(61, 0, M_TYPE::KEY,						M_DRAW::UP,		v3(PW / 2,1150 - 30,0),	true, v3(50,30,0), 10),




	STAGE_DATA(61, 0, M_TYPE::IVY_THICK,				M_DRAW::UP,		v3(0,1050,1),		true, v3(PW,17,0), 10),
	...
	STAGE_DATA(62, 0, M_TYPE::IVY_THICK,				M_DRAW::UP,		v3(0,540,1),		true, v3(PW,17,0), 10),
	...
	STAGE_DATA(62, 0, M_TYPE::RECOVERY_DOWN,			M_DRAW::DOWN,	v3(PW / 2,215,1),		true, v3(160,22,0), 2, recoveryControl),
