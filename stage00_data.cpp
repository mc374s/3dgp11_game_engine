...
STAGE_DATA stage00_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 1 + 0], 0, M_TYPE::KEY,						M_DRAW::UP,		v3(PW / 2,PH / 2 - 111,0),	true, v3(124,111,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 1 + 0] + 1, 0, M_TYPE::DOOR,					M_DRAW::UP,		v3(450,PH / 2 - 111,0),	true, v3(124,111,0), 8),
