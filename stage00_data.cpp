...
STAGE_DATA stage00_setData[] = {
	...
	// 濃度の高いマスク(コマ)
	STAGE_DATA(0, MAPOBJ_HIGH_CONCENTRATION, DRAW_UP, false, v3(44,222,1),true, v3(400,300,0), 5),
	...
	STAGE_DATA(0, MAPOBJ_IVY_THIN, DRAW_UP, false, v3(22,200,0),true, v3(444,22,0), 10),
	STAGE_DATA(0, MAPOBJ_IVY_THIN, DRAW_DOWN, false, v3(22,522,0),true, v3(444,22,0), 10),
	STAGE_DATA(0, MAPOBJ_IVY_THIN, DRAW_LEFT, false, v3(22,200,0),true, v3(22,344,0), 10),
	STAGE_DATA(0, MAPOBJ_IVY_THIN, DRAW_RIGHT, false, v3(444,200,0),true, v3(22,344,0), 10),
