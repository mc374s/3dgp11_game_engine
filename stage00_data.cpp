...
STAGE_DATA stage00_setData[] = {
	...
	STAGE_DATA(0, MAPOBJ_IVY_THIN, DRAW_UP, true, v3(120,650,1),true, v3(280,22,0), LOW_CONCENTRATION),
	...
	STAGE_DATA(0, MAPOBJ_IVY_THIN, DRAW_UP, false, v3(0,650,1),true, v3(PW,22,0), LOW_CONCENTRATION),
