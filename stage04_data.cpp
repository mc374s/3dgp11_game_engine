...
STAGE_DATA stage04_setData[] = {
	...
	STAGE_DATA(e_startPagination[4], 0, M_TYPE::RECOVERY_UP,			M_DRAW::UP,		v3(155,460,1),		true, v3(155,11,0), 2, recoveryControl),
	...
	STAGE_DATA(e_startPagination[4] + 1, 0, M_TYPE::RECOVERY_DOWN,			M_DRAW::DOWN,		v3(0,220-8,1),		true, v3(PW,11,0), 2, recoveryControl),
