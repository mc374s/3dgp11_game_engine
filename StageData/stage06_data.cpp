...
STAGE_DATA stage06_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 3 + 6], 0, M_TYPE::KEY_1_1,					M_DRAW::UP,		v3(20,200 - 99,0),	true, v3(111,99,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 3 + 6] + 1, 0, M_TYPE::RECOVERY,				    M_DRAW::UP,		v3(570,850 - 64,0),	true, v3(64,64,0), 2),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 3 + 6] + 1,0, M_TYPE::DOOR_1_1,					M_DRAW::UP,		v3(PW / 2,1039 - 99,0),	true, v3(111,99,0), 8),
