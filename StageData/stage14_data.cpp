...
STAGE_DATA stage14_setData[] = {
	...
	//ページ２
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 14] + 1, 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(0,200,1),		true, v3(465,11,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 14] + 1, 0, M_TYPE::DOOR_5_1,					M_DRAW::UP,		v3(100,600 - 99,0),	true, v3(128, 99,0), 10),
