...
STAGE_DATA stage14_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 14], 0, M_TYPE::DOOR_1_1,					M_DRAW::UP,		v3(50,300 - 99,0),	true, v3(111,99,0), 8),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 14] + 1, 0, M_TYPE::KEY_1_1,						M_DRAW::UP,		v3(PW / 2,500 - 99,0),	true, v3(111,99,0), 10),
