...
STAGE_DATA stage01_setData[] = {
	...
	//STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 1 + 1], 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(155,680,1),		true, v3(155,22,0), 3),
	//STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 1 + 1], 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,	v3(465,680,1),		true, v3(155,22,0), 3),
