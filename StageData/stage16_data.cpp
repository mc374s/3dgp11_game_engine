...
STAGE_DATA stage16_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 16], 0, M_TYPE::PASSABLE_UP,			M_DRAW::UP,		v3(155,460,1),		true, v3(155,11,0), 0, recoveryControl),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 16], 0, M_TYPE::KEY,						M_DRAW::UP,		v3(400,440 - 111,0),	true, v3(124,111,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 16] + 1, 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,		v3(0,220 - 8,1),		true, v3(PW,11,0), 0, recoveryControl),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 16] + 1,	 0,	M_TYPE::DOOR,						M_DRAW::UP,		v3(530,680 - 111,0),	true, v3(124,111,0), 8),
