...
STAGE_DATA stage11_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 11], 0, M_TYPE::DOOR,					M_DRAW::UP,		v3(50,220 - 76,0),	true, v3(70,76,0), LOW_CONCENTRATION),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 11] + 1, 0, M_TYPE::KEY,						M_DRAW::UP,		v3(120,900 - 58,0),	true, v3(70,58,0), 10),
