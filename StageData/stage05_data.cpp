...
STAGE_DATA stage05_setData[] = {
	...
	STAGE_DATA(e_startPagination[5], 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(PW / 2,680,1),		true, v3(310,11,0), 10),
	STAGE_DATA(e_startPagination[5], 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(155,680,1),		true, v3(155,11,0), 0, recoveryControl),
	STAGE_DATA(e_startPagination[5], 0, M_TYPE::RECOVERY,				M_DRAW::UP,		v3(50,680 - 64,0),	true, v3(64,64,0), 2),
