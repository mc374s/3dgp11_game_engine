...
STAGE_DATA stage05_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 5], 0, M_TYPE::KEY,					M_DRAW::UP,		v3(20,220 - 111,0),	true, v3(124,111,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 5] + 1,0, M_TYPE::DOOR,					M_DRAW::UP,		v3(480,500 - 111,0),	true, v3(124,111,0), 8),
