...
STAGE_DATA stage05_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 5], 0, M_TYPE::KEY_1_1,					M_DRAW::UP,		v3(20,220 - 99,0),	true, v3(111,99,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 5] + 1,0, M_TYPE::DOOR_1_1,					M_DRAW::UP,		v3(480,500 - 99,0),	true, v3(111,99,0), 8),
