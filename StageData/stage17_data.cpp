...
STAGE_DATA stage17_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 17], 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(470,220,1),		true, v3(150,11,0), 0, recoveryControl),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 17], 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(155,680,1),		true, v3(155,11,0), 0, recoveryControl),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 17], 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,	v3(465,680 - 8,1),		true, v3(155,11,0), 0, recoveryControl),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 17], 0, M_TYPE::DOOR,					M_DRAW::UP,		v3(50,220 - 111,0),	true, v3(124,111,0), 8),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 17] + 1, 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,	v3(PW / 2,220 - 8,1),		true, v3(160,11,0), 0, recoveryControl),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 17] + 1, 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(500,540,1),		true, v3(120,11,0), 0, recoveryControl),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 5 + 17] + 1, 0, M_TYPE::KEY,						M_DRAW::UP,		v3(120,900 - 111,0),	true, v3(124,111,0), 10),
