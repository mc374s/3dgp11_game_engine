...
STAGE_DATA stage04_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4], 0, M_TYPE::DOOR,					M_DRAW::UP,		v3(50,220 - 111,0),	true, v3(124,111,0), 8),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4], 0, M_TYPE::BIRD_6,				M_DRAW::UP,		v3(390,680 - 111,0),	false, v3(182,111,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4] + 1, 0, M_TYPE::KEY,						M_DRAW::UP,		v3(120,900 - 111,0),	true, v3(124,111,0), 10),
