...
STAGE_DATA stage04_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4], 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(470,220,1),		true, v3(150,11,0), 0),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4], 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(155,680,1),		true, v3(155,11,0), 0),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4], 0, M_TYPE::RECOVERY,				M_DRAW::UP,		v3(50,680 - 64,0),	true, v3(71,64,0), 2),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4], 0, M_TYPE::DOOR_2_1,					M_DRAW::UP,		v3(50,220 - 131,0),	true, v3(117, 131,0), 8),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4], 0, M_TYPE::BIRD_6,				M_DRAW::UP,		v3(390,680 - 99,0),	false, v3(182,111,0), 10),


	//ページ２
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4] + 1, 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(0,220,1),		true, v3(PW / 2 + 11,11,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4] + 1, 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,	v3(PW / 2,220 - 8,1),		true, v3(160,11,0), 0),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4] + 1, 0, M_TYPE::PASSABLE_UP,				M_DRAW::UP,		v3(500,540,1),		true, v3(120,11,0), 0),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4] + 1, 0, M_TYPE::HIGH_CONCENTRATION,		M_DRAW::UP,		v3(0,231,0),		true, v3(PW / 2,309,0), 3),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 4] + 1, 0, M_TYPE::KEY_2_1,						M_DRAW::UP,		v3(120,900 - 131,0),	true, v3(117, 131,0), 10),
