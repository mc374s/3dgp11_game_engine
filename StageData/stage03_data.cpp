...
STAGE_DATA stage03_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 3], 0, M_TYPE::BIRD_3,				M_DRAW::MIRROR,		v3(420,460 - 91,0),	false, v3(190,91,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 3] + 1, 0, M_TYPE::BIRD_2,				M_DRAW::UP,		v3(300,220 - 137,0),	false, v3(138,137,0), 10),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 3] + 1, 0, M_TYPE::BIRD_3,				M_DRAW::UP,		v3(420,220 - 91,0),	false, v3(190,91,0), 10),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 3] + 1, 0, M_TYPE::BIRD_7,				M_DRAW::UP,		v3(340,680 - 165,0),	false, v3(158,165,0), 10),
