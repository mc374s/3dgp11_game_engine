...
STAGE_DATA stage03_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3], 0, M_TYPE::KEY_1_1,						M_DRAW::UP,		v3(50,440 - 99,0),	true, v3(111,99,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3] + 1,	 0,	M_TYPE::DOOR_1_1,						M_DRAW::UP,		v3(100,680 - 99,0),	true, v3(111,99,0), 8),
