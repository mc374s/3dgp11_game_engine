...
STAGE_DATA stage03_setData[] = {
	...
	//STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 4], 0, M_TYPE::RECOVERY,				M_DRAW::UP,		v3(50,680 - 64,0),	true, v3(71,64,0), 2),


	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3], 0, M_TYPE::PASSABLE_UP,			M_DRAW::UP,		v3(155,460,1),		true, v3(155,11,0), 0),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3], 0, M_TYPE::KEY_2_1,						M_DRAW::UP,		v3(50,440 - 131,0),	true, v3(117, 131,0), 10),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3], 0, M_TYPE::TUTORIAL_4,				M_DRAW::UP,		v3(300,120,0),	false, v3(239,55,0), 10),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3], 0, M_TYPE::PASSABLE_ARROW,			M_DRAW::DOWN,		v3(200,480,0),	false, v3(74,94,0),10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3] + 1, 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,		v3(0,220 - 8,1),		true, v3(PW / 2,11,0), 0),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3] + 1,	 0,	M_TYPE::DOOR_2_1,						M_DRAW::UP,		v3(100,680 - 131,0),	true, v3(117, 131,0), 8),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3] + 1, 0, M_TYPE::TUTORIAL_6,				M_DRAW::UP,		v3(160,30,0),	false, v3(327,60,0), 10),

	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 2 + 3] + 1, 0, M_TYPE::PASSABLE_ARROW,			M_DRAW::UP,		v3(110,120,0),	false, v3(74,94,0),10),
