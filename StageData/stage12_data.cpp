...
STAGE_DATA stage12_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 12], 0, M_TYPE::KEY,					M_DRAW::UP,		v3(20,200 - 58,0),	true, v3(70,58,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 12] + 1,0, M_TYPE::DOOR,					M_DRAW::UP,		v3(PW / 2,1039 - 76,0),	true, v3(70,76,0), LOW_CONCENTRATION),
