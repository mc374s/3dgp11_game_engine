...
STAGE_DATA stage08_setData[] = {
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8], 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(155,250,1),		true, v3(465,11,0), 10),
	//STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8], 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(0,480,1),		true, v3(155,11,0), 10),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8], 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(0,480,1),		true, v3(PW,11,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8], 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,	v3(0,250 - 8,1),		true, v3(155,11,0), 0, recoveryControl),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8], 0, M_TYPE::PASSABLE_DOWN,			M_DRAW::DOWN,	v3(0,1250 - 8,1),		true, v3(PW / 2,11,0), 0, recoveryControl),


	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8], 0, M_TYPE::KEY,						M_DRAW::UP,		v3(50,480 - 111,0),	true, v3(124,111,0), 10),
	...
	//ページ２
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8] + 1, 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(120,250,1),		true, v3(35,11,0), 10),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8] + 1, 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(PW / 2,250,1),		true, v3(PW / 2,11,0), 10),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8] + 1, 0, M_TYPE::BORDER_INNER,				M_DRAW::UP,		v3(0,480,1),		true, v3(465,11,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8] + 1, 0, M_TYPE::BORDER_INNER,				M_DRAW::LEFT,	v3(465,260,1),		true, v3(11,220,0), 10),
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8] + 1, 0, M_TYPE::BORDER_INNER,				M_DRAW::LEFT,	v3(PW / 2,850,1),		true, v3(11,550,0), 10),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8] + 1,0,M_TYPE::DOOR,					M_DRAW::UP,		v3(500,1550 - 111,0),	true, v3(124,111,0), LOW_CONCENTRATION),
	...
	STAGE_DATA(e_startPagination[STAGE_SELECT_MAX_NUM + 8] + 1,0, M_TYPE::RECOVERY,				M_DRAW::UP,		v3(500,1400 - 64,0),	true, v3(64,64,0), 2),
