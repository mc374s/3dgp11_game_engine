...
SPRITE_BOTTOM e_pAnimePlayerYawn[] = {
	...
	SPRITE_BOTTOM(TEX_PLAYER, 0 + 60 * 0, 85, 60, 78, 8),
	SPRITE_BOTTOM(TEX_PLAYER, 0 + 60 * 1, 85, 60, 78, 8),
	SPRITE_BOTTOM(TEX_PLAYER, 0 + 60 * 2, 85, 60, 78, 8),
	SPRITE_BOTTOM(TEX_PLAYER, 0 + 60 * 3, 85, 60, 78, 8),
	SPRITE_BOTTOM(TEX_PLAYER, 0 + 60 * 4, 85, 60, 78, 8),
	SPRITE_BOTTOM(TEX_PLAYER, 0 + 60 * 5, 85, 60, 78, 8),
	SPRITE_BOTTOM(TEX_PLAYER, 0 + 60 * 6, 85, 60, 78, 8),
	SPRITE_BOTTOM(TEX_PLAYER, 0 + 60 * 7, 85, 60, 78, 8),
	SPRITE_BOTTOM(-1, 0, 0, 0, 0),
};
