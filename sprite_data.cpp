...
SPRITE_BOTTOM e_sprEyes = SPRITE_BOTTOM(TEX_PLAYER_EYES, 0, 0, 1280, 720);
...
SPRITE_LEFTTOP e_pSprItem[] =
{
	...
	SPRITE_LEFTTOP(TEX_GOAL_SET, 100, 460, 101, 133),	// M_TYPE::DOOR_3_1:
	SPRITE_LEFTTOP(TEX_GOAL_SET, 100, 593, 101, 133),	// M_TYPE::KEY_3_1:
	SPRITE_LEFTTOP(TEX_GOAL_SET, 201, 460, 101, 133),	// M_TYPE::DOOR_3_2:
	SPRITE_LEFTTOP(TEX_GOAL_SET, 201, 593, 101, 133),	// M_TYPE::KEY_3_2:

	SPRITE_LEFTTOP(TEX_GOAL_SET, 100, 735, 100, 129),	// M_TYPE::DOOR_4_1:
	SPRITE_LEFTTOP(TEX_GOAL_SET, 100, 855, 100, 129),	// M_TYPE::KEY_4_1:
	SPRITE_LEFTTOP(TEX_GOAL_SET, 200, 735, 100, 129),	// M_TYPE::DOOR_4_2:
	SPRITE_LEFTTOP(TEX_GOAL_SET, 200, 855, 100, 129),	// M_TYPE::KEY_4_2:
	SPRITE_LEFTTOP(TEX_GOAL_SET, 300, 735, 100, 129),	// M_TYPE::DOOR_4_3:
