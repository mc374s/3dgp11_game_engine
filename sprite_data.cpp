...
SPRITE_LEFTTOP e_pSprItem[] =
{
	...
	SPRITE_LEFTTOP(TEX_MAP_OBJECT, 248, 0,  99, 112),// MAPOBJ_TREE_B
	SPRITE_LEFTTOP(TEX_MAP_OBJECT, 347, 0,  79,  47),// MAPOBJ_IVY_BIG
	SPRITE_LEFTTOP(TEX_IVY_THIN,	    0, 0, 125,  22),// MAPOBJ_IVY_THIN
