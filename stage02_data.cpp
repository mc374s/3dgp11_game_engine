...
STAGE_DATA stage02_setData[] = {
	...
	STAGE_DATA(e_startPagination[2], 0, M_TYPE::DOOR,					M_DRAW::UP,		v3(50,300 - 76,0),	true, v3(51,76,0), LOW_CONCENTRATION),
	...
	STAGE_DATA(e_startPagination[2] + 1, 0, M_TYPE::KEY,						M_DRAW::UP,		v3(PW / 2,500 - 30,0),	true, v3(50,30,0), 10),
