...
STAGE_DATA stage01_setData[] = {
	...
	STAGE_DATA(e_startPagination[1], 0, M_TYPE::KEY,						M_DRAW::UP,		v3(PW / 2,PH / 2 - 30,0),	true, v3(50,30,0), 10),
	...
	STAGE_DATA(e_startPagination[1] + 1, 0, M_TYPE::DOOR,					M_DRAW::UP,		v3(450,PH / 2 - 76,0),	true, v3(51,76,0), LOW_CONCENTRATION),
